...
test('current page routes V1.6.4 through the household-unlock engine while retaining the relation-tree UI', () => {
  ...
  assert.match(index, /family-work-ui\.js\?v=1\.6\.4-player-work/);

...
test('V1.7.2 keeps V1.7.1 compact density and loads the overview layout layer', () => {
  ...
  assert.match(html, /v172-ui\.js\?v=1\.7\.2/);
});
...
test('V1.7.2 next-goal helper is view-only and reads current progression', () => {

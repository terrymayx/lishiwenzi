...
test('V1.11.4 loads one presentation layer and drops V1.9/V1.10 visual controllers', () => {
...
test('V1.11.4 shell is self-contained and does not depend on V1.9 DOM builders', () => {
...
test('V1.11.4 keeps top resources on one line and gives the target dashboard fixed visual roles', () => {

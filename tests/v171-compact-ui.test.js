...
test('compact UI remains the base while V1.11.2 is the only active presentation layer', () => {
  ...
  const currentIndex = sheets.indexOf('./v211.css?v=1.11.2');
  ...
  assert.ok(currentIndex > monthlyIndex, 'V1.11.2 is the final visual layer');
  ...
  assert.equal(sheets.at(-1), './v211.css?v=1.11.2');

...
test('V1.11.3 current-task text uses explicit high-contrast readable styles', () => {
...
test('V1.11.3 task rail avoids inherited blur-producing transforms and filters', () => {
  const css = read('dist/v211.css');
...
test('V1.11.3 is exposed by page and controller', () => {

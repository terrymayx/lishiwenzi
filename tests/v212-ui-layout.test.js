...
test('V1.11.4 puts current task and next-month control in the right rail', () => {
...
test('V1.11.4 keeps next month visible in the right column and reduces the bottom dashboard to three summaries', () => {
...
test('V1.11.4 gives business industry text an explicit readable parchment palette', () => {
  const css = read('dist/v211.css');
...
test('V1.11.4 version is exposed by the page and UI controller', () => {

...
test('V1.8.1 guide uses cash rather than total household assets for money thresholds', async () => {
...
test('V1.8.1 cash-threshold rule remains documented beneath the V1.8.2 release', () => {
  ...
  assert.match(index, /V1\.8\.1 当前任务现金门槛/);
